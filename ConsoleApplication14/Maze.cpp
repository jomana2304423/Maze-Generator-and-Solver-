...
//void Maze::displayMaze() // printing the maze walls 
//{
//    // Top border
//    cout << " ";
...
//{
//    if (path.empty()) {
//        cout << "No path to display.\n";
//        return;
//    }
//
//    // Make a grid for marking the path
//    vector<vector<char>> mazeMap(height, vector<char>(width, ' '));
//
//    // Mark cells in the path
//    for (auto& p : path) {
//        mazeMap[p.second][p.first] = '*';
//    }
//
//    cout << "Maze with solution path (marked with *):\n";
//
//    // Top border
//    cout << " ";
//    for (int i = 0; i < width; i++) {
